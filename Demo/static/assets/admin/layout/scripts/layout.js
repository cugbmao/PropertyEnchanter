...
var Layout = function () {
    ...
    var layoutImgPath = '/static/assets/admin/layout/img/';
    ...
    var handleTheme = function () {
        ...
        var setColor = function (color) {
            ...
            $('#style_color').attr("href", "/static/assets/admin/layout/css/themes/" + color_ + ".css");
            if (color == 'light2') {
                $('.page-logo img').attr('src', '/static/assets/admin/layout/img/logo-invert.png');
            } else {
                $('.page-logo img').attr('src', '/static/assets/admin/layout/img/logo.png');
            }
            if ($.cookie) {                
